...
import { TextGenerateEffect } from '../text-genEffect'; // <--- 1. Import TextGenerateEffect
      ...
      <main>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 ">
          <div className="text-center">
            <TextGenerateEffect
  words="Connect with Your Community"
  className="text-4xl sm:text-5xl font-bold text-cream-50 mb-6"
  filter={true}
  duration={1.2}
/>
